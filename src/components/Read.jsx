  ...
  return (
    <div>
      ...
      <button className="btn btn-success ">
        <Link className="input-search_1" to='/create' >Add User</Link>
      </button>
            ...
            .map((element) => (
              <div className="card  read-class" key={element.id}>
                ...
                <div className="card-body ">
                  ...
                  Email : <span className="input-search">{element.email}</span> 
                  </p>
                  <p className="card-text text-left text-secondary">
                  Gender : <span className="input-search">{element.gender}</span> 
                  </p>
                </div>
                <div className="mb-3">
                  <button
                    className="card-link btn btn-outline-primary btn-sm input-search "
                    onClick={() => openModal(element.id)}
                  >
                    View
                  </button>

                  <button className="card-link btn btn-outline-success btn-sm input-search ">
                  ...
                  <button
                    className="card-link btn btn-outline-danger btn-sm input-search "
